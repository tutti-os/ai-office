...
import type { AiEditRequest, CreateProjectRequest, UpdateDeckSlideHtmlRequest, UpdateProjectRequest } from "@ai-slide/shared";
...
const projects = new ProjectService(new ProjectRepository());
