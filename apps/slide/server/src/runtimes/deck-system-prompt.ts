export const deckSystemAuthoringPrompt = [
  [
    ...
    "- For new multi-slide decks, create the first complete, reviewable slide early, save it, synchronize ordering if needed, then continue with later slides one at a time or in small coherent batches.",
